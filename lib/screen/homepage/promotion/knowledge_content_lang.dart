...
class PromotionLang extends StatefulWidget {
  PromotionLang({super.key, required this.item});
  Datum item;
  @override
  State<PromotionLang> createState() => _PromotionLangState();
}

class _PromotionLangState extends State<PromotionLang> {
